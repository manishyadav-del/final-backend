                      ...
                      {ads.map((ad) => (
                        <tr key={ad.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40">
                          ...
                          <td className="p-3 text-center">
                            <div className="font-semibold">{ad.clicks} Clicks</div>
                            <div className="text-[10px] text-slate-400">{ad.impressions} Imps</div>
                          </td>
            ...
            <form onSubmit={handleCreateAd} className="space-y-3">
              ...
              {newAd.type === "banner" ? (
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    placeholder='<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-XXX" ...>'
                    value={newAd.code}
                  ...
                  {zones.map((zone) => (
                    <div key={zone.id} className="p-4 flex justify-between items-center">
                      <div>
                        ...
                        <div className="text-[10px] text-slate-400 mt-0.5">Slug: {zone.slug}</div>
                      </div>
                      <div className="text-right">
                        <span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-700/80 rounded-md font-medium text-[10px]">
                          {zone.width && zone.height ? `${zone.width}x${zone.height}` : "Responsive size"}
                        </span>
                      </div>
                    </div>
                  ))}
